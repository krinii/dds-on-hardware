...
#include "HelloWorld_3PubSubTypes.h"
...
public:
    ...
    {
        FILE *fp;
        fp = fopen("/home/k/Desktop/Workspaces/Master_Project/Git_Repositories/dds-on-hardware/performance_tests/FastDDS/writeSpeedTest/data/test_1.txt", "a");
        fprintf(fp, "NewRound\n");
        fclose(fp);
