...
#error Generated MyType is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
...
public:
    ...
    eProsima_user_DllExport MyTypePubSubType();

    eProsima_user_DllExport virtual ~MyTypePubSubType();
