...
#define MAX_SAMPLES 1 //100 //1000000
...
int main (int argc, char ** argv)
{
  ...
  FILE *fp;
  fp = fopen("/home/k/Desktop/Workspaces/Master_Project/Git_Repositories/dds-on-hardware/performance_tests/CycloneDDS/writingSpeedTest_BF/data/test_4.txt", "a");
  fprintf(fp, "NewRound\n");
  fclose(fp);
  int tmp_msg_count = 0;
  while (sigintH){
