...
int main (int argc, char ** argv)
{
  ...
  while (sigintH){
    ...
    for (int i = 0; i < 5; i++){
      ...
      fp = fopen("/home/k/Desktop/Workspaces/Master_Project/Git_Repositories/dds-on-hardware/performance_tests/CycloneDDS/writingSpeedTest/data/test_150_bytes.txt", "a");
      fprintf(fp, "%d,%d,\n", i, tmp_msg_count);
      fclose(fp);
