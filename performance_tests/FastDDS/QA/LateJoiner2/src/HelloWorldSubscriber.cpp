...
public:
    ...
    HelloWorldSubscriber()
        ...
        , topic_(nullptr)
        , reader_(nullptr)
        , type_(new HelloWorldingPubSubType())
    {
    }
    ...
    bool init()
    {
        ...
        topic_ = participant_->create_topic("HelloWorldTopic", "HelloWorlding", TOPIC_QOS_DEFAULT);
        ...
        drQos.reliability().max_blocking_time = 7;
