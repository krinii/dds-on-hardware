...
/*!
 * @brief This class represents the TopicDataType of the type HelloWorlding defined by the user in the IDL file.
 * @ingroup HELLOWORLD
 */
class HelloWorldingPubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef HelloWorlding type;

    eProsima_user_DllExport HelloWorldingPubSubType();

    eProsima_user_DllExport virtual ~HelloWorldingPubSubType();
